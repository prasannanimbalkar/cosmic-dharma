/** English zodiac sign names (1 = Aries … 12 = Pisces) */
export const RASHIS_ENGLISH = [
  'Aries',
  'Taurus',
  'Gemini',
  'Cancer',
...
/** Abbreviations used inside chart houses (matches common Jyotish apps) */
...
export type ChartTab = 'lagna' | 'navamsha' | 'moon'
